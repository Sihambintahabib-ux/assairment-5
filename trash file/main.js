...
// number
var serviceNum = document.querySelectorAll(".call-num");
...
copyActionBtn.forEach(btn => {
    btn.addEventListener("click", (e) => {
        ...
        // ====
        // alert function : 
        const copy_btns = btn.parentNode.parentNode;
        const serviceNum = copy_btns.querySelector(".call-num").textContent;
        // ====
        ...
        callBtns[i].addEventListener("click", function () {
            ...
            copyActionBtn.forEach(btn => {
                btn.addEventListener("click", (e) => {
                    ...
                    // serviceNum = btn.querySelector(".call-num").innerText;

                    copyCount++;
                    showBtnCopy.textContent = copyCount + " copy";
                    alert(`copying :  ${serviceNum} + "btn number is : " ${btn}`);
                });
            });
